...
This program analyzes data from XXX and YYY ITC calorimeters.
The data format is expected to be in 6 columns, formatted like: XXX YYY ZZZ AAA BBB CCC. Please see the included file for an example. 
